...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
    ...
    <form action="" method="post">
        ...
        <input type="text" id="coursename" name="coursename" placeholder="Python For Everybody" autofocus required><br>
        ...
        <input type="text" id="video" name="video" placeholder="File Location" required><br>
        <div class="col-25">
            <label for="duration">Duration:</label></div>
        <input type="text" id="duration" name="duration" placeholder="01:00" autofocus required><br>

        <div class="col-25">
            <label for="assessment">Assessment:</label></div>
        <input type="text" id="assessment" name="assessment" placeholder="File Location" autofocus required><br>

        <div class="col-25">
            <label for="certificate">Certificate:</label></div>
        <input type="text" id="certificate" name="certificate" placeholder="File Location" autofocus required><br>
